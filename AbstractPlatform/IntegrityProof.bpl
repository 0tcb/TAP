    ...
    modifies tap_enclave_metadata_cache_conflict_2;
{
    ...
    var e_container_valid                    : container_valid_t;
    ...
    // now launch an enclave.
    call InitOSMem(e_container_valid, e_container_data);
