procedure refinement_proof_step_enter_enclave();
    ...
    requires (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && vpn == vaddr2vpn(va) && in_enclave_mem(va, cpu_evbase, cpu_evmask) && tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> tap_sanctum_perm_eq(cpu_addr_valid[va], ptbl_acl_map[cpu_eptbr, vpn]));
    requires (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && in_enclave_mem(va, cpu_evbase, cpu_evmask) && tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> (cpu_addr_map[va] == paddr2wpaddr(ptbl_addr_map[cpu_eptbr, vpn] ++ vaddr2offset(va))));
    requires (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && !in_enclave_mem(va, cpu_evbase, cpu_evmask) && !tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> tap_sanctum_perm_eq(cpu_addr_valid[va], ptbl_acl_map[cpu_ptbr, vpn]));
    requires (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && !in_enclave_mem(va, cpu_evbase, cpu_evmask) && !tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> (cpu_addr_map[va] == paddr2wpaddr(ptbl_addr_map[cpu_ptbr, vpn] ++ vaddr2offset(va))));
...
procedure refinement_proof_step_exit_enclave();
    ...
    ensures (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && vpn == vaddr2vpn(va) && in_enclave_mem(va, cpu_evbase, cpu_evmask) && tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> tap_sanctum_perm_eq(cpu_addr_valid[va], ptbl_acl_map[cpu_eptbr, vpn]));
    ensures (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && in_enclave_mem(va, cpu_evbase, cpu_evmask) && tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> (cpu_addr_map[va] == paddr2wpaddr(ptbl_addr_map[cpu_eptbr, vpn] ++ vaddr2offset(va))));
    ensures (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && !in_enclave_mem(va, cpu_evbase, cpu_evmask) && !tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> tap_sanctum_perm_eq(cpu_addr_valid[va], ptbl_acl_map[cpu_ptbr, vpn]));
    ensures (forall va: vaddr_t, vpn : vpn_t :: (core_info_enclave_id != null_enclave_id && cpu_enclave_id != tap_null_enc_id && vpn == vaddr2vpn(va) && enclave_metadata_is_initialized[core_info_enclave_id] && tap_enclave_metadata_valid[cpu_enclave_id] && !in_enclave_mem(va, cpu_evbase, cpu_evmask) && !tap_enclave_metadata_addr_excl[cpu_enclave_id][va]) ==> (cpu_addr_map[va] == paddr2wpaddr(ptbl_addr_map[cpu_ptbr, vpn] ++ vaddr2offset(va))));
